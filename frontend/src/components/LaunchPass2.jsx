  ...
  return (
    <div className="w-full flex justify-center px-4 md:px-0">
      <div
        ...
        "
      >
        <div className="w-full p-5 md:p-10 flex flex-col gap-4 md:gap-2">
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-25">
            ...
            <div className="w-full md:w-auto flex flex-col gap-2">
              ...
              <div className="flex flex-col gap-2">
                <div className="mt-2 md:mt-5 text-white text-lg md:text-xl font-inter font-extralight">
                  Postal Code*
                </div>
                <input
                  type="text"
                  ...
                  className="px-4 py-3 w-full md:w-80 h-11 md:h-10 bg-transparent rounded-md text-white border border-white/70 placeholder-white/30"
                  placeholder="0000111"
                />
              </div>
              ...
              <div className="flex justify-center md:justify-start gap-4 md:gap-5 pt-4 md:pt-0">
                <button
                  disabled={isSubmitting}
                  onClick={handleBack}
                  className="w-28 h-10 mt-2 md:mt-5 mb-2 md:mb-5 bg-transparent rounded-md border border-white/70 text-white"
                >
                  Back
                </button>
            ...
            {/* SUMMARY SECTION (SECOND ON MOBILE) */}
            <div className="w-full md:w-auto flex flex-col gap-5 pb-2">
              <div className="text-white font-aspekta text-left md:text-right">
                Summary
              </div>

              <div className="w-full">
                <div className="grid grid-cols-[auto_1fr] w-full gap-y-6 md:gap-y-10 items-start">
                  <div className="text-white text-lg md:text-xl font-aspekta font-extralight">
                    Item
                  </div>
                  ...
                  <div className="flex justify-end items-start gap-2">
                    ...
                    <span className="text-white text-lg md:text-xl font-aspekta font-extralight leading-snug text-right">
                      Business <br />
                      Networking Pass x 1
                    </span>
                  </div>
                  ...
                  <div className="text-white text-right text-lg md:text-xl font-aspekta font-light">
